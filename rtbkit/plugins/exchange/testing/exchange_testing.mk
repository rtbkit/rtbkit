...
# rubicon_exchange_connector originally build with "cairomm-1.0"
$(eval $(call test,rubicon_exchange_connector_test,rubicon_exchange bid_test_utils openrtb_exchange bidding_agent rtb_router,boost))

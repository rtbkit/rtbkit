...
$(eval $(call test,gumgum_exchange_connector_test,gumgum_exchange bid_test_utils bidding_agent rtb_router agents_bidder,boost))
$(eval $(call test,bidswitch_exchange_connector_test,bidswitch_exchange bid_test_utils openrtb_bid_request bidding_agent rtb_router agents_bidder,boost))
$(eval $(call test,bidswitch_exchange_connector_adx_test,bidswitch_exchange bid_test_utils openrtb_bid_request bidding_agent rtb_router agents_bidder,boost))
$(eval $(call test,bidswitch_filters_test,static_filters bidswitch_exchange,boost))
$(eval $(call test,nexage_exchange_connector_test,nexage_exchange bid_test_utils openrtb_bid_request bidding_agent rtb_router agents_bidder,boost))

...
$(eval $(call test,mopub_exchange_connector_test,mopub_exchange bid_test_utils openrtb_exchange bidding_agent rtb_router cairomm-1.0 cairo sigc-2.0,boost manual))

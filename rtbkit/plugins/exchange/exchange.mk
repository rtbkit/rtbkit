...
$(eval $(call library,openrtb_exchange,openrtb_exchange_connector.cc,exchange bid_test_utils openrtb_bid_request_parser))
...
$(eval $(call library,gumgum_exchange,gumgum_exchange_connector.cc,exchange bid_test_utils openrtb_bid_request_parser))

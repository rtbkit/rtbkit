...
struct FilterState
{
    ...
    /*
     * This map is keyed by filtered reasons and contains a list of ConfigIndex.
     * Of course, those configs belonging to those configIndex were filtered
     * due to the given reason.
     */
    typedef std::map<std::string, std::list<unsigned> > FilterReasons;

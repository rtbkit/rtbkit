...
$(eval $(call program,ad_server_connector_ex,exchange rtb_router boost_program_options services))
$(eval $(call program,router_ex,exchange router_runner boost_program_options services))

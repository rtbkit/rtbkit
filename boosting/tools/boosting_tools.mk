...
$(eval $(call program,classifier_training_tool,boosting boosting_tools utils arch worker_task ACE boost_program_options-mt boost_regex-mt $(if $(findstring 1,$(CUDA_ENABLED)), boosting_cuda),,tools))

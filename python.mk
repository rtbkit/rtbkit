...
$(TESTS)/$(1).passed:	$(CWD)/$(1).py $$(foreach lib,$(2),$$(PYTHON_$$(lib)_DEPS)) $$(foreach pymod,$(2),pymod_$$(pymod))
...
$(BIN)/$(1): $(CWD)/$(2) $(BIN)/.dir_exists $$(foreach pymod,$(3),pymod_$$(pymod)) $$(foreach pymod,$(3),$$(PYTHON_$$(pymod)_DEPS))
